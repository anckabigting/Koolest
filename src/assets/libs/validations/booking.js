...
export const bookingSchema = z.object({
  fullName: z.string().min(2, "Full name must be at least 2 characters long").max(100, "Full name is too long").trim().regex(/^\S+\s+\S+/, "Please enter your full name (first and last name)"),
